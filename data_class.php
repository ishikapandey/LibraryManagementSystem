...
class data extends db {
    ...
    function addnewuser($name,$password,$email,$type){
        ...
        if($this->connection->exec($q)) {
            header("Location:admin_service_dashboard.php?msg=New Addition done");
        }

        else {
            header("Location:admin_service_dashboard.php?msg=Registeration Fail");
        }
    ...
    function returnbook($id){
        ...
        // if($fine!=0){
        //     header("Location:otheruser_dashboard.php?userlogid=$id&msg=fine");
        // }
